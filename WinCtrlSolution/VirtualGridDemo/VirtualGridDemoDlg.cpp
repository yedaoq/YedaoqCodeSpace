...
void CVirtualGridDemoDlg::OnGridGetDispInfo(NMHDR* pNMHDR, LRESULT* pResult)
{
	...
	if (pDispInfo->item.mask & LVIF_TEXT)  {
		...
		case 0:		//  #
			_itot(pDispInfo->item.nRow + 1, buffer, 10);
		...
		case 1:		//  Point name
			...
			break;
		case 2:		//  X
			_itot(m_demoData[pDispInfo->item.nRow].m_x, buffer, 10);
			pDispInfo->item.strText = buffer;
			break;
		case 3:		//  Y
			_itot(m_demoData[pDispInfo->item.nRow].m_y, buffer, 10);
			pDispInfo->item.strText = buffer;
			break;
		case 4:		//  Z
			_itot(m_demoData[pDispInfo->item.nRow].m_z, buffer, 10);
			pDispInfo->item.strText = buffer;
			break;
		case 5:
...
void CVirtualGridDemoDlg::OnGridSetDispInfo(NMHDR* pNMHDR, LRESULT* pResult)
{
	...
	case 1:		//  Point name
		...
		break;
	case 4:
		m_demoData[pDispInfo->item.nRow].m_z = _ttoi(pDispInfo->item.strText);
		break;
	default:
		break;
	}
