...
IMPLEMENT_DYNCREATE(CGridCellComboBox, CGridCell)

CGridCellComboBox::CGridCellComboBox() : CGridCell()
{
...
CWnd* CGridCellComboBox::GetEditWnd() const
{
...
CSize CGridCellComboBox::GetCellExtent(CDC* pDC)
{    
...
DWORD CGridCellComboBox::GetStyle()                       
{ 
	//CCellEditStyleOptional* style = static_cast<CCellEditStyleOptional*>(m_TextFormatter->editSytle());  
	//return (style->otheracceptable ? CBS_DROPDOWN : CBS_DROPDOWNLIST);
	return CBS_DROPDOWN;
}

// Cancel the editing.
void CGridCellComboBox::EndEdit()
{
    if (m_pEditWnd)
