...
#define CopyLF(lfDest, lfSource) \
    ...
    _tcscpy_s(lfDest.lfFaceName, LF_FACESIZE, lfSource.lfFaceName)
...
int AllocatedStringArray_Append(LPTSTR *lpszzTarget, int iCharCount, LPTSTR szSource)
{
    ...
    *lpszzTarget = (LPTSTR) realloc(*lpszzTarget, (count + 1) * sizeof(TCHAR));
    _tcscpy(*lpszzTarget + iCharCount - 1, szSource);
...
static BOOL Main_OnNotify(HWND hwnd, INT id, LPNMHDR pnm)
{
    if(IDC_PG == id)
    {
        ...
        {
            case 0:
                _stprintf_s(gDemoData.strProp1, NELEMS(gDemoData.strProp1),
#ifdef _UNICODE
                    _T("%ls"),
#else
                    _T("%s"),
                ...
                break;
            case 1:
                _stprintf_s(gDemoData.strProp2, NELEMS(gDemoData.strProp2),
#ifdef _UNICODE
                    _T("%ls"),
#else
                    _T("%s"),
            ...
            case 2:
            {
                _stprintf_s(gDemoData.strProp3, NELEMS(gDemoData.strProp3),
#ifdef _UNICODE
                    _T("%ls"),
#else
                    _T("%s"),
            ...
            case 13:
            {
                ...
                break;
            case 14:
                _stprintf_s(gDemoData.strProp8, NELEMS(gDemoData.strProp8),
                    ((LPPROPGRIDFDITEM)Item->lpCurValue)->lpszFilePath);
                break;
            case 15:
                _stprintf_s(gDemoData.strProp9, NELEMS(gDemoData.strProp9),
                    (LPTSTR)Item->lpCurValue);
                break;
            case 16:
        ...
        {
            TCHAR buf[MAX_PATH];
            _stprintf_s(buf, MAX_PATH, _T("Check Boxes: %#lx = %s"),
...
BOOL Main_OnInitDialog(HWND hwnd, HWND hwndFocus, LPARAM lParam)
{
    ...
    // Initialize DemoData
    _stprintf_s(gDemoData.strProp1, NELEMS(gDemoData.strProp1),_T("Property Grid demo"));
    
    memset(gDemoData.strProp2, 0, sizeof(gDemoData.strProp2));
    _tcscpy_s(gDemoData.sczzChoices, NELEMS(gDemoData.sczzChoices), _T("Item1\0Item2\0Item3\0Item4\0Item5\0"));

    memset(gDemoData.strProp3, 0,sizeof(gDemoData.strProp3));
    ...
    _tcscpy_s(gDemoData.szzChoices, gDemoData.dwChoicesCount, szzChoices);

    _stprintf_s(gDemoData.strProp4, NELEMS(gDemoData.strProp4),_T("Static, no edit"));
    ...
    _stprintf_s(gDemoData.strProp8, NELEMS(gDemoData.strProp8),_T("C:\\test.txt"));
    _stprintf_s(gDemoData.strProp9, NELEMS(gDemoData.strProp9),_T("C:\\"));
