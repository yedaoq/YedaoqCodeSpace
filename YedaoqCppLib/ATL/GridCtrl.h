...
public:
	...
	public:
		...
		virtual void OnCellActivate(UINT uID, long nRow, long nCol) {}
...
protected:
	...
	public:
		...
		void EditCell(long row=-1,long col=-1) {
			if(m_bEditing || m_dwStyle & GS_EX_READONLY) return;
			if(col<0) col = m_nSelectedCol;
