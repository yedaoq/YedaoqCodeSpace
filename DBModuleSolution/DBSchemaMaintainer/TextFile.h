...
public:
	...
	BOOL	WriteTextFile( CString& filename, const IEnumerator<tstring>& contents );
	BOOL	WriteTextFile( CString& filename, const tstring& contents );

	BOOL	AppendFile( CString& filename, const tstring& contents );
	BOOL	AppendFile( CString& filename, const IEnumerator<tstring>& contents );
